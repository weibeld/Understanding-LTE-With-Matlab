% modScram64QamHard - Run BER evaluation on simple communication system.
%
...
%
% Usage:
%   [ber, nBits] = modScram64QamHard(EbNo, maxErrs, maxBits)
%
...
function [ber, nBits] = modScram64QamHard(EbNo, maxErrs, maxBits)
