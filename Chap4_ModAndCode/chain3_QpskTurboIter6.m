% chain3_QpskTurboIter6 - Run BER evaluation on simple communication system.
%
...
%   - Turbo decoding with 6 iterations
%
% Usage:
%   [ber, nBits] = chain3_QpskTurboIter6(EbNo, maxErrs, maxBits)
%
...
function [ber, nBits] = chain3_QpskTurboIter6(EbNo, maxErrs, maxBits)
