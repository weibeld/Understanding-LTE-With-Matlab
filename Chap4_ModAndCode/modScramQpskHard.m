% modScramQpskHard - Run BER evaluation on simple communication system.
%
...
%
% Usage:
%   [ber, nBits] = modScramQpskHard(EbNo, maxErrs, maxBits)
%
...
function [ber, nBits] = modScramQpskHard(EbNo, maxErrs, maxBits)
