% mod16QamHard - Run BER evaluation on simple communication system.
%
...
%
% Usage:
%   [ber, nBits] = mod16QamHard(EbNo, maxErrs, maxBits)
%
...
function [ber, nBits] = mod16QamHard(EbNo, maxErrs, maxBits)
