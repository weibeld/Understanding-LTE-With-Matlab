% chain2_QpskSoft - Run BER evaluation on simple communication system.
%
...
%
% Usage:
%   [ber, nBits] = chain2_QpskSoft(EbNo, maxErrs, maxBits)
%
...
function [ber, nBits] = chain2_QpskSoft(EbNo, maxErrs, maxBits)
