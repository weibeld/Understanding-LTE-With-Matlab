% chain1_16QamSoft- Run BER evaluation on simple communication system.
%
...
%
% Usage:
%   [ber, nBits] = chain1_16QamSoft(EbNo, maxErrs, maxBits)
%
...
function [ber, nBits] = chain1_16QamSoft(EbNo, maxErrs, maxBits)
