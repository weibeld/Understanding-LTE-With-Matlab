% chain2_16QamkSoft - Run BER evaluation on simple communication system.
%
% The communication system consists of:
%   - Scrambling
%   - 16QAM modulation
%   - AWGN channel
%   - 16QAM demodulation with soft-decision (LLR output)
%   - Descrambling of LLRs
%
% Usage:
%   [ber, nBits] = chain2_16QamkSoft(EbNo, maxErrs, maxBits)
%
...
function [ber, nBits] = chain2_16QamkSoft(EbNo, maxErrs, maxBits)
