% chain1_QpskHard - Run BER evaluation on simple communication system.
%
...
%
% Usage:
%   [ber, nBits] = chain1_QpskHard(EbNo, maxErrs, maxBits)
%
...
function [ber, nBits] = chain1_QpskHard(EbNo, maxErrs, maxBits)
