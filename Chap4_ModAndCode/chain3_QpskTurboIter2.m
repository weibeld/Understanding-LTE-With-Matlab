% chain3_QpskTurboIter2 - Run BER evaluation on simple communication system.
%
...
%   - Turbo decoding with 2 iterations
%
% Usage:
%   [ber, nBits] = chain3_QpskTurboIter2(EbNo, maxErrs, maxBits)
%
...
function [ber, nBits] = chain3_QpskTurboIter2(EbNo, maxErrs, maxBits)
