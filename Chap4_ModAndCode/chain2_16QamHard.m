% chain2_16QamkHard - Run BER evaluation on simple communication system.
%
...
%
% Usage:
%   [ber, nBits] = chain2_16QamkHard(EbNo, maxErrs, maxBits)
%
...
function [ber, nBits] = chain2_16QamkHard(EbNo, maxErrs, maxBits)
