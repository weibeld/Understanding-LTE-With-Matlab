% Convolutional encoding and soft-decision decoding with low-level functions.
%
...
%
% This example demonstrates the use of the low-level functions 'convenc',
% 'vitdec', 'awgn', 'quantiz', and 'biterr'.
...
if strcmp(opMode, 'cont')
  ...
  msgS      = msg(1:end-(k*tracebackDepth));
else
  yDecodedS = yDecoded;
  msgS      = msg;
end
...
[nErr ber] = biterr(msgS, yDecodedS);
